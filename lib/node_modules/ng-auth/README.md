 ![Serious Trust](https://raw.githubusercontent.com/lynndylanhurley/ng-auth/master/test/app/images/serious-trust.jpg "Serious Trust")

[![Bower version](https://badge.fury.io/bo/ng-auth.svg)](http://badge.fury.io/bo/ng-auth)
[![Build Status](https://travis-ci.org/lynndylanhurley/ng-auth.svg?branch=master)](https://travis-ci.org/lynndylanhurley/ng-auth)
[![Test Coverage](https://codeclimate.com/github/lynndylanhurley/ng-auth/coverage.png)](https://codeclimate.com/github/lynndylanhurley/ng-auth)
...
# [Live Demo](http://ng-auth-demo.herokuapp.com/)

This project comes bundled with a test app. You can run the demo locally by following [these instructions](#development), or you can use it [here in production](http://ng-auth-demo.herokuapp.com/).
...
* Download this module and its dependencies:   
  ...
  bower install ng-auth --save
  ~~~
  
* Ensure that [angularjs](https://github.com/angular/angular.js), [ng-cookies](https://docs.angularjs.org/api/ngCookies), and ng-auth are included on your page: 
  ~~~html
  <!-- in your index.html file -->
  <script src="/js/angular/angular.js"></script>
  <script src="/js/angular-cookies/angular-cookies.js"></script>
  <script src="/js/ng-auth/dist/ng-auth.js"></script>
  ~~~
  
* Include `ng-auth` in your module's dependencies:
  ~~~javascript
  // in your js app's module definition
  angular.module('myApp', ['ng-auth'])
  ~~~
...
### [View Live Multi-User Demo](http://ng-auth-demo.herokuapp.com/multi-user)
...
![oauth flow](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/omniauth-flow.jpg)
...
Rails example: [controller](https://github.com/lynndylanhurley/ng-auth-api-rails/blob/master/app/controllers/users/auth_controller.rb#L21), [layout](https://github.com/lynndylanhurley/ng-auth-api-rails/blob/master/app/views/layouts/oauth_response.html.erb), [view](https://github.com/lynndylanhurley/ng-auth-api-rails/blob/master/app/views/users/auth/oauth_success.html.erb).
...
![validation flow](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/validation-flow.jpg)

## Email registration flow

This module also provides support for email registration. The following diagram illustrates this process.

![email registration flow](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/email-registration-flow.jpg)

## Email sign in flow

![email sign in flow](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/email-sign-in-flow.jpg)

## Password reset flow

The password reset flow is similar to the email registration flow.

![password reset flow](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/password-reset-flow.jpg)
...
![password reset flow](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/token-update-detail.jpg)
...
![batch request overview](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/batch-request-overview.jpg)
...
![batch request detail](https://github.com/lynndylanhurley/ng-auth/raw/master/test/app/images/flow/batch-request-detail.jpg)
...
* Make sure that you make changes to the CoffeeScript source file (`src/ng-auth.coffee`) and not the compiled distribution file (`dist/ng-auth.js`). If the [dev server](#running-the-dev-server) is running, the coffescript will be compiled automatically. You can also run `gulp transpile` from the project root to compile the code.
...
Satellizer occupies the same problem domain as ng-auth. Advantages of ng-auth (at the time of this writing) include:
  * [Events](#events).
